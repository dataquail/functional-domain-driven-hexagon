...
- Adding a new module is mechanical: create the folders the module needs and add a `<feature>-module.ts` Layer. The barrel-only dependency rules apply automatically to any folder under `src/modules/` or `src/public/` (ADR-0008).
