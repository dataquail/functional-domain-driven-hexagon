...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ | --- | ------------------------------------------------------------------------------------------------------------------- |
| Domain unit              | `modules/<f>/domain/*.root.test.ts` etc.                                                                                             | `Effect.runSync` or none                                                 | no  | Pure ops, invariants, validation                                                                                    |
| Use-case unit            | `modules/<f>/{commands,event-handlers}/*.handler.test.ts`                                                                            | Effect runtime + fake repo + recording event bus + identity unit of work | no  | Command / event-handler behavior, event emission, error paths                                                       |
