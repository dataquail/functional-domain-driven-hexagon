...
//   - integration (MSW + real ApiClient): exercised from
...
export interface UsersPageDriver {
  ...
  // visible. Acceptance: sonner's DOM. Integration: sonner's DOM
  // (the integration harness mounts <Toaster />). Presenter: the
