...
// has to allowlist `@org/cqrs`'s internal file paths, which couples an enforcement
...
export * from "@org/cqrs/event";

/** `Event.Base` under the name the aggregates use for it. */
export type { Base as DomainEvent } from "@org/cqrs/event";
