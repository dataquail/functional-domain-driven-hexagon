...
// permitted to reach another module's vocabulary, through wallet.imports.ts. It translates
...
export const OrganizationEventAdapterLive = Layer.effectDiscard(
  Effect.gen(function* () {
    ...
    yield* domainEventBus.subscribe(organizationAccessDomainEvents.OrganizationCreated, (event) =>
