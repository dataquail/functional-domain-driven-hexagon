...
export class AlreadyHasRole extends Schema.TaggedError<AlreadyHasRole>("AlreadyHasRole")(
  "AlreadyHasRole",
...
export class DoesNotHaveRole extends Schema.TaggedError<DoesNotHaveRole>("DoesNotHaveRole")(
  "DoesNotHaveRole",
  { userId: UserId, role: RoleValueObject },
) {}
...
export class CannotPromoteSelf extends Schema.TaggedError<CannotPromoteSelf>("CannotPromoteSelf")(
  "CannotPromoteSelf",
  { userId: UserId },
) {}
