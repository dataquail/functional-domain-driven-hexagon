...
const isOrgMember = makeIsOrgMember<Organization>((organization) => organization.id);
...
// resolver loads the Organization, and this check runs normally) and
...
export const IsMemberRead: PolicyRegistry.CheckFor<"organization", "read"> = (
  ...
  (organization as Organization | undefined) === undefined
