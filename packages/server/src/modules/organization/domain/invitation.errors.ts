...
export class InvitationTokenNotFound extends Schema.TaggedErrorClass<InvitationTokenNotFound>(
...
export class InvitationAlreadyRevoked extends Schema.TaggedErrorClass<InvitationAlreadyRevoked>(
