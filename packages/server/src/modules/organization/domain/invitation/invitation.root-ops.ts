...
// already terminal (accepted/revoked) or past its expiration. Marks the
// invitation accepted; the membership that acceptance produces is
// orchestrated by the InvitationAcceptance domain service (the invitation
// aggregate does not reach into the membership aggregate).
const accept = (
