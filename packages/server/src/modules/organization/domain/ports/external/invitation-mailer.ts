...
// `infrastructure/external/` owns all of that (it builds the accept URL
...
export class InvitationMailer extends Context.Tag("@org/server/organization/InvitationMailer")<
  InvitationMailer,
  InvitationMailerShape
>() {}
