...
import { type CompleteTodoPayload } from "@/modules/todos/commands/complete-todo.command.js";
...
export const completeTodoHandler = Effect.fn("completeTodoHandler")(function* (
  cmd: CompleteTodoPayload,
) {
