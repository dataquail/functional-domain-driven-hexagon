...
import { type ApproveDeviceGrantPayload } from "@/modules/auth/commands/approve-device-grant.command.js";
import {
  DeviceGrantExpired,
  DeviceGrantNotFound,
...
export const approveDeviceGrantHandler = Effect.fn("approveDeviceGrantHandler")(function* (
  cmd: ApproveDeviceGrantPayload,
) {
