...
// `/auth/me` reports whether the caller is a platform super admin. That fact is
// the role module's, so auth reaches it through this port and never learns the
// role vocabulary.
...
describe("PlatformRolesLive (auth)", () => {
